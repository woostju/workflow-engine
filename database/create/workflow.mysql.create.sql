...
CREATE TABLE `WORKFLOW_DEF` (
  ...
  `CREATOR_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '创建人',
  `LAST_MODIFIER_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '最后修改人',
...
CREATE TABLE `WORKFLOW_DEF_REV` (
  ...
  `DEF_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '流程定义id',
...
CREATE TABLE `WORKFLOW_INST` (
  ...
  `STATUS` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '状态',
  `DEF_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '流程定义ID',
  `DEF_REV_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '流程定义版本ID',
...
CREATE TABLE `WORKFLOW_INST_ACTIVITY` (
  ...
  `OPERATOR_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '操作人id',
  `OPERATE_TIME` datetime NOT NULL COMMENT '操作时间',
  `CONTENT` json NOT NULL COMMENT '操作内容',
  `WORKFLOW_TASK_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'workflow任务ID',
  `WORKFLOW_INST_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `WORKFLOW_INST_TASK` (
  ...
  `PROCESS_TASK_DEF_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `STATUS` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '状态',
  `TYPE` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '类型',
  `EXECUTOR_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '执行人id',
...
CREATE TABLE `WORKFLOW_OBJECT_ENTITY_REL` (
  ...
  `OBJECT_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '对象ID',
  `ENTITY_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '实体ID',
...
-- ----------------------------
-- Table structure for WORKFLOW_INST_TIMER_JOB
-- ----------------------------
DROP TABLE IF EXISTS `WORKFLOW_INST_TIMER_JOB`;
CREATE TABLE `WORKFLOW_INST_TIMER_JOB` (
       `ID` varchar(64) NOT NULL COMMENT 'ID',
       `WORKFLOW_INST_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'WORKFLOW实例 ID',
       `WORKFLOW_TASK_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'WORKFLOW TASK ID',
       `ADD_ON` json DEFAULT NULL COMMENT '附属信息',
       `STATUS` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '状态',
       `TRIGGER_TIME` datetime DEFAULT NULL COMMENT '触发事件',
       `END_TIME` datetime DEFAULT NULL COMMENT '结束时间',
       `PROCESS_TIMER_DEF_ID` varchar(64) NOT NULL COMMENT 'acitiviti timer定义id',
       `PROCESS_TIMER_JOB_ID` varchar(64) DEFAULT NULL COMMENT 'acitiviti timer job id',
       PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='流程任务上的Timer任务';
