...
drop table ACT_TASK_ASSIGNEE;
drop table WORKFLOW_DEF;
drop table WORKFLOW_DEF_REV;
drop table WORKFLOW_INST;
drop table WORKFLOW_INST_ACTIVITY;
drop table WORKFLOW_INST_TASK;
drop table WORKFLOW_OBJECT_ENTITY_REL;