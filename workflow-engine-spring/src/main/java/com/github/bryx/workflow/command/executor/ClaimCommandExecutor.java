...
import com.github.bryx.workflow.command.ClaimCommand;
...
public class ClaimCommandExecutor extends BaseCommandExecutor<Void, ClaimCommand> {
    ...
    @Transactional
    public Void run() {
        ClaimCommand command = this.getCommand();
