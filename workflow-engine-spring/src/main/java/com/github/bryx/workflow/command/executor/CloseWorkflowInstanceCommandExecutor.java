...
public class CloseWorkflowInstanceCommandExecutor extends CommandExecutor<Void, CloseWorkflowInstanceCommand> {
    ...
    @Transactional
    public Void run() {
        CloseWorkflowInstanceCommand command = this.getCommand();
