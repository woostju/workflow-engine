...
import com.github.bryx.workflow.command.ModifyCommand;
...
public class ModifyCommandExecutor extends BaseCommandExecutor<Void, ModifyCommand> {
    ...
    @Transactional
    public Void run() {
        ModifyCommand command = this.getCommand();
