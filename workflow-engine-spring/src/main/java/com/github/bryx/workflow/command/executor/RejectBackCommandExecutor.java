...
import com.github.bryx.workflow.command.RejectBackCommand;
...
public class RejectBackCommandExecutor extends BaseCommandExecutor<List<String>, RejectBackCommand> {
    ...
    public List<String> run() {
        RejectBackCommand command = this.getCommand();
        ...
        List<String> newWorkflowTaskInstanceIds = this.getCommandExecutorHelper()
