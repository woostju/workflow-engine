...
public interface ProcessService {
	 ...
	 * @return
	 * 
	 * 获取当前任务, 任务中不包含timers，包含受理人候选人信息
	 */
	 ...
	 * @return
	 * 
	 * 获取流程定义详情,定义中的taskObjects不包含timers信息
	 */
	 ...
	 * @param processId
	 * @return
	 * get all historic activities on process, you can display historic on web site
	 * 
	 */
	 ...
	 *
	 * @param taskId
	 * @param timerBoudryElementId
	 * @param duration
	 * @param timeUnit supports DAYS, MINUTES, HOURS, SECONDS for timer
	 */
	 ...
	 * @param taskId
	 * @param timerBoudryElementId
	 * @param cron cron expression of timer trigger time
	 */
